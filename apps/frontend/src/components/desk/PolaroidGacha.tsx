  ...
  return (
    ...
    <>
      ...
      {isGachaOpen && typeof window !== "undefined" && createPortal(
        ...
        // 1. SỬA OUTER: Khóa cứng ở giữa, bỏ scroll

        <div className={`fixed inset-0 z-[99999] w-screen h-screen flex items-center justify-center overflow-hidden ${isGachaClosing ? 'animate-gacha-overlay-out' : 'animate-gacha-overlay-in'}`}>

          

          {/* Lớp nền đen nhận sự kiện click để đóng */}

          <div className="absolute inset-0 bg-black/80 backdrop-blur-md pointer-events-auto" onClick={handleCloseGacha} />



          {/* 2. LỚP BỌC AUTO ZOOM VÀO ĐÂY */}
          ...
          >
            ...
            <div className={`relative flex flex-col items-center justify-center perspective-1000 w-[400px] h-[650px] z-10 ${isGachaClosing ? 'animate-gacha-content-out' : 'animate-gacha-content-in'}`}>
